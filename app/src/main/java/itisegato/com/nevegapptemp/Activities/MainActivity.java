...
import itisegato.com.nevegapptemp.Fragments.PointFragment;
import itisegato.com.nevegapptemp.Fragments.TematicheFragment;
import itisegato.com.nevegapptemp.R;

/**
 *  Main Activity
 *  Contiene l'intera grafica principale: gestisce il drawer laterale e lo scorrimento delle tre sezioni
 *  (mappa, punti, temi)
 */
public class MainActivity extends AppCompatActivity
    ...
    private TematicheFragment tematicheFragment;
    ...
    /**
     * Gestione BottomNavigationView: tap pulsanti e spostamenti di fragment
     */
            ...
            switch (item.getItemId()) {
                case R.id.navigation_mappa:
                    getSupportFragmentManager().beginTransaction()
                            ...
                            .replace(R.id.frameLayoutFragment, mMapFragment)
                            .commit();
                    return true;
                case R.id.navigation_punti:
                    getSupportFragmentManager().beginTransaction()
                            .setCustomAnimations(android.R.anim.fade_in,android.R.anim.fade_out)
                            .replace(R.id.frameLayoutFragment, new PointFragment())
                            .commit();
                    return true;
                case R.id.navigation_tematiche:
                    getSupportFragmentManager().beginTransaction()
                            .setCustomAnimations(android.R.anim.fade_in,android.R.anim.fade_out)
                            .replace(R.id.frameLayoutFragment, new TematicheFragment())
                            .commit();
                    return true;
            }
            return false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] permissions = {Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.WRITE_EXTERNAL_STORAGE,
                Manifest.permission.ACCESS_COARSE_LOCATION, Manifest.permission.INTERNET, Manifest.permission.ACCESS_NETWORK_STATE};
        ...
        mFragmentTransaction.add(R.id.frameLayoutFragment, mMapFragment);
    ...
    /**
     *  Metodo che fa apparire la guida rapida, ne gestisce l'apertura automatica al primo avvio
     */
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.section_condividi) {
            ...
            String shareBodyText = "https://play.google.com/store/apps/details?id=itisegato.com.nevegapptemp";
