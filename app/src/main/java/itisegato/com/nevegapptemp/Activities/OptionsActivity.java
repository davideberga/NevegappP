...
public class OptionsActivity extends AppCompatActivity {
    ...
    private void selezionaContenuto(){
        if(getIntent().getStringExtra(MainActivity.SECTION).equals(MainActivity.CREDITI)){
            ((TextView) findViewById(R.id.testoOpzioni)).setText(getResources().getText(R.string.contenuto_Crediti));
        }
        else if(getIntent().getStringExtra(MainActivity.SECTION).equals(MainActivity.ABOUTUS)){
            ((TextView) findViewById(R.id.testoOpzioni)).setText(getResources().getText(R.string.contenuto_aboutUs));
        }
        else if(getIntent().getStringExtra(MainActivity.SECTION).equals(MainActivity.ABOUTNEVEGAPP)){
            ((TextView) findViewById(R.id.testoOpzioni)).setText(getResources().getText(R.string.contenuto_aboutNevegApp));
        }
            ...
            ((TextView) findViewById(R.id.testoLicenza)).setText(getResources().getText(R.string.contenuto_licenza));
        }
        else if(getIntent().getStringExtra(MainActivity.SECTION).equals(MainActivity.BIBLIOGRAFIA)){
            ((TextView) findViewById(R.id.testoOpzioni)).setText(getResources().getText(R.string.contenuto_bibliografia));
        }
    }
}
